...
import 'forgot_password_screen.dart'; // Đã thêm cái này
              ...
              child: Padding(
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.school, size: 100, color: Colors.blue.shade800),
                      ...
                      // Nút Quên mật khẩu chèn thêm vào đây
                      Align(
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: _isLoading
                              ...
                              : Text("Đăng nhập", style: TextStyle(fontSize: 16, color: Colors.white)),
                        ),
                      ),
                      SizedBox(height: 16.0),
                      TextButton(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(color: Colors.blue.shade800, fontSize: 15, fontWeight: FontWeight.bold),
                        ),
                      ),
                    ],
                  ),
